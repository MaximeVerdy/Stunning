...
export default function MentionsLegales () {
    ...
    return (
        ...
        <div>
            ...
            <p>Si après nous avoir donné votre consentement, vous changez d’avis et ne consentez plus à ce que nous puissions vous contacter, recueillir vos renseignements ou les divulguer, vous pouvez nous en aviser en nous contactant à verdy.dev@gmail.com ou par courrier à: Stunning, 56 boulevard Pereire , Paris, J, 75017, France </p>
            ...
            <p>Une fois que vous quittez le site de notre site ou que vous êtes redirigé vers le site web ou l’application d’un tiers, vous n’êtes plus régi par la présente Politique de Confidentialité ni par les Conditions Générales de Vente et d’Utilisation de notre site web.</p>
